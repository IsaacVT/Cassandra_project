...
import { Box, Button, Grid, MenuItem, Modal, Stack, Typography } from '@mui/material';
...
export default function ProductModalDelete({ product }) {
  ...
  const deleteProd = () => {
    ...
    try {
      Promise.resolve(RemoveProd(id)).then((res) => {
        ...
        <Grid sx={{ ...style, width: 700 }} container spacing={1}>
          ...
          <Grid item xs={6}>
            <Stack alignItems={'center'} spacing={8} sx={{ mt: 8, mb: 10 }}>
              <Typography variant="h4">Do you want to delete this product?</Typography>
              ...
              <Stack direction={'row'} spacing={6}>
                <Button
                  ...
                  variant="contained"
                  color="warning"
                  startIcon={<KeyboardReturnRoundedIcon sx={{ fontSize: 'h1.fontSize' }} />}
                  sx={{ width: 'auto' }}
                >
                  Cancel
                </Button>
                ...
                <Button
                  ...
                  variant="contained"
                  color="error"
                  endIcon={<DeleteRoundedIcon sx={{ fontSize: 'h1.fontSize' }} />}
                  sx={{ width: 'auto' }}
                >
                  Delete
                </Button>
