...
import { RemoveShopping } from '../../../services/shopping-service';
// Services
...
ShoppingModalDelete.propTypes = {
    row: PropTypes.object,
};

export default function ShoppingModalDelete({ row }) {

    const shopping = row.row;
